...
public class MathUtils {
    ...
    // Put these into an array along with all constants from 1 to 10 found here https://en.wikipedia.org/wiki/Stieltjes_constants#Numerical_values, then implement them into the Zeta function.
    ...
    public static BigDecimal nCr(long n, long r) {
        return Factorial.factorial(n).divide(Factorial.factorial(n - r), RoundingMode.HALF_UP).divide(Factorial.factorial(r), RoundingMode.HALF_UP);
    }

...
public class MathUtils {
    ...
    public static final BigDecimal bdGamma = new BigDecimal(0.5772156649015328606065120900824024310421593359399235988057672348848677267776646709369470632917467495146314472498070824809605040);
    public static final BigDecimal bdOmega = new BigDecimal(0.5671432904097838729999686622103555497538157871865125081351310792230457930866845666932194469617522945576380249728667897854523584);
    ...
    public static BigDecimal nCr(long n, long r) {
        return Factorial.factorial(n).divide(Factorial.factorial(n - r)).divide(Factorial.factorial(r));
    }

...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("d/dx of Gamma(1) = " + NumericalDerivative.derivative("gamma",1,1, 1));
        ...
        System.out.println("Zeta(0.5) = " + Zeta.zeta(0.5));
        System.out.println("Zeta(0.5) = " + Zeta.zetaDefinerRaw(0.5));
        /*
